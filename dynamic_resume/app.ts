...
// display resume
  ...
  (document.getElementById("display_profile_text") as HTMLElement).textContent =
    profile;
  ...
  (document.getElementById("display_education") as HTMLElement).textContent =
    education;
  ...
  if (profilePicture) {
    ...
    reader.onload = () => {
      (
        document.getElementById("display_profile_picture") as HTMLImageElement
